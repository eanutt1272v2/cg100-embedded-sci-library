# Render the Mandelbrot set fractal on the Casio fx-CG100.
...
def main():
    param_cr = read_float("cr (-0.75): ", default=-0.75)
    param_ci = read_float("ci (0.0): ", default=0.0)
